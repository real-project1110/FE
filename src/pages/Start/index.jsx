...
const Start = () => {
  ...
  const section2_2_y = useTransform(scrollYProgress, [0.25, 0.35], [400, 0]);
  const section2_2_opacity = useTransform(
    scrollYProgress,
    [0.25, 0.35],
    [0, 1]
  );
  const section2_3_y = useTransform(scrollYProgress, [0.46, 0.56], [400, 0]);
  const section2_3_opacity = useTransform(
    scrollYProgress,
    [0.46, 0.56],
    [0, 1]
  );
  const section2_4_y = useTransform(scrollYProgress, [0.68, 0.8], [400, 0]);
  const section2_4_opacity = useTransform(scrollYProgress, [0.68, 0.8], [0, 1]);
  const section3_y = useTransform(scrollYProgress, [0.83, 0.93], [400, 0]);
