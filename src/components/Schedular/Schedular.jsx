...
const Schedular = () => {
  ...
  const { isLoading, isError, data, error, refetch } = useQuery(["schedules", groupId], () => readSchedule(groupId), {
    ...
    <Wrapper>
      ...
      >
        <div className="mbsc-form-group">
          <Input label="제목" value={isEdit ? popupEventTitle : addTitle} onChange={titleChange} />
          <Textarea label="상세 내용" value={popupEventDescription} onChange={descriptionChange} />
        </div>
        <div className="mbsc-form-group">
